    ...
    <div className="min-h-screen h-safe relative overflow-x-hidden transition-colors duration-700">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden bg-[var(--color-bg)]">
        <div className={`absolute inset-0 transition-opacity duration-1000 ${backgroundOpacity > 0 ? 'opacity-0' : 'opacity-100'}`}>
          <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] opacity-30 animate-blob will-change-transform" style={{ background: 'radial-gradient(closest-side, var(--color-ambient-1), transparent)' }}></div>
          <div className="absolute top-[-10%] right-[-10%] w-[60vw] h-[60vw] opacity-30 animate-blob animation-delay-2000 will-change-transform" style={{ background: 'radial-gradient(closest-side, var(--color-ambient-2), transparent)' }}></div>
          <div className="absolute bottom-[-20%] left-[20%] w-[60vw] h-[60vw] opacity-30 animate-blob animation-delay-4000 will-change-transform" style={{ background: 'radial-gradient(closest-side, var(--color-ambient-3), transparent)' }}></div>
        </div>
        <div
      ...
      <style>{`
        ...
        @keyframes ken-burns { 0% { transform: scale3d(1, 1, 1); } 100% { transform: scale3d(1.1, 1.1, 1.1); } }
        .animate-ken-burns { animation: ken-burns 20s alternate infinite ease-in-out; will-change: transform; }
        @keyframes blob { 0% { transform: translate3d(0px, 0px, 0) scale3d(1, 1, 1); } 33% { transform: translate3d(30px, -50px, 0) scale3d(1.1, 1.1, 1.1); } 66% { transform: translate3d(-20px, 20px, 0) scale3d(0.9, 0.9, 1); } 100% { transform: translate3d(0px, 0px, 0) scale3d(1, 1, 1); } }
